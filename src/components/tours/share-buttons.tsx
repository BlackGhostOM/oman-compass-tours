...
export function ShareButtons({
  ...
  return (
    <div className={cn("flex flex-wrap items-center gap-2", className)}>
      ...
      <Button asChild variant="outline" size="icon-sm" aria-label="X">
      ...
      <Button asChild variant="outline" size="icon-sm" aria-label="Facebook">
      ...
      <Button variant="outline" size="icon-sm" onClick={copy} aria-label={t("copyLink")}>
        <Link2 className="size-4" />
      </Button>
      <Button variant="outline" size="icon-sm" onClick={nativeShare} aria-label={t("share")} className="sm:hidden">
